...
describe("Accordion.cy.jsx", () => {
  it("Items Accordion", () => {
    ...
    //clicking the accordion again to hide the content
    cy.getTestData("accordion-item-1").within(()=>{
      cy.get('[role="button"]').click()
    })
  });
